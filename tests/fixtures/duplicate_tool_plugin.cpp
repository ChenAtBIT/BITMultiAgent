...
PluginTool tools[] = {
    {"duplicate_tool.echo", "duplicate_tool__echo", "First duplicate tool.", schema, schema},
    {"duplicate_tool.echo", "duplicate_tool__echo", "Second duplicate tool.", schema, schema}
};
int api_version() { return MCP_PLUGIN_API_VERSION; }
const char* id() { return "duplicate_tool"; }
const char* name() { return "Duplicate Tool Fixture"; }
const char* version() { return "1.0.0"; }
int initialize() { return 1; }
void shutdown() {}
int count() { return 2; }
const PluginTool* tool(int index) { return index >= 0 && index < count() ? &tools[index] : nullptr; }
